...
const FAQ = () => {
    return(
        <div className="ml-48 mr-48 mt-20 p-8 text-white border-white border-2 bg-pink-400 rounded-lg">
           ...
           <Accordion>
            ...
            <p className="font-Futura text-lg font-light">A) You need to be in middle school, high school, or college.</p>
           </Accordion>
          
           <Accordion>
            <p className="font-Futura text-xl hover:font-bold">Q) Do all members need to be the same age?</p>
            <p className="font-Futura text-lg font-light">A) No. Members can be of all ages, though the dynamic between chapter leads and members may vary
           ...
           <Accordion>
            ...
            <p className="font-Futura text-lg font-light">A) Start a community based chapter and meet with members outside of school in your own time.</p>
           </Accordion>
           ...
           <Accordion>
            ...
            <p className="font-Futura text-lg font-light">A) As soon as you complete the online form you will be given a Google folder with all of the instructions and
           ...
           <Accordion>
            ...
            <p className="font-Futura text-lg font-light">A) We mandate monthly check-ins where you will provide numbers, events, and any photos you wish to
